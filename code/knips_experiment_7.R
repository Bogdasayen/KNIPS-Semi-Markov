...
states <- data.table( # Non-other cause death health states
  state_id = 1:4,
  state_name = c("Post TKR", "Post 1st revision", "Post 2nd revision", "Surgery Death")
) 
...
tkr_mortality_90d_probability <- rbeta(n_samples, shape1 = beta_params_temp[1], shape2 = beta_params_temp[2])
...
revision_mortality_90d_probability <- rbeta(n_samples, shape1 = beta_params_temp[1], shape2 = beta_params_temp[2])
...
rerevision_mortality_90d_probability <- rbeta(n_samples, shape1 = beta_params_temp[1], shape2 = beta_params_temp[2])
...
for(implant_name in implant_names) {
  ...
  for(i_sample in 1:n_samples) {
    ...
    # with(x, prob[strategy_id ==1 & sample == 1 & t==15])
