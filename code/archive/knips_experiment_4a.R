...
for(i_sample in 1:n_samples) {
  ...
  transmod_params <- params_surv_list(
    ...
    params_surv(coefs = list(
      gamma0 = data.frame(int = rcs_first_revision[i_sample, "cons"]),
      gamma1 = data.frame(int = rcs_first_revision[i_sample, "rcs1"]),
      gamma2 = data.frame(int = rcs_first_revision[i_sample, "rcs2"]),
      gamma3 = data.frame(int = rcs_first_revision[i_sample, "rcs3"])),  
      aux = list(
